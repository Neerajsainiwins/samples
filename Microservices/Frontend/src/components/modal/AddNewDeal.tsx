                ...
                <ModalContent>
                    <FieldRow className="formWrapper">
                        <Grid>
                            <GridColumn width={8}>
                                <p>Deal name</p>
                                <input type="text" placeholder="DAVIGOLD"></input>
                            </GridColumn>
                            <GridColumn width={8}>
                                <p>Country</p>
                                <input type="text" placeholder="France"></input>
                            </GridColumn>
                        </Grid>                        
                    </FieldRow>                   

                    <FieldRow className="actionBtn">
                        <CommonFillBtn onClick={props.close}>Add new deal</CommonFillBtn>
                    </FieldRow>
                </ModalContent>
            </CreateViewWrapper>               
